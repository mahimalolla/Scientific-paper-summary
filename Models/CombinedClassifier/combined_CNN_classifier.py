...
from Dev.DataTools.useful_functions import Color, wait, printlist, num2onehot, BASE_DIR, PAPER_SOURCE, HIGHLIGHT_SOURCE,\
    PAPER_BAG_OF_WORDS_LOC, KEYPHRASES_LOC, GLOBAL_COUNT_LOC, weight_variable, bias_variable, conv2d, max_pool_2x2
from Dev.Evaluation.rouge import Rouge
...
keep_prob = graph_outputs[2]

# Loss function to minimize
loss = graph_outputs[3]

# Optimisation operation
opt = graph_outputs[4]

# Predictions as probabilities
predictions = graph_outputs[5]

# Argmaxed predictions and labels
pred_answers = graph_outputs[6]
correct_answers = graph_outputs[7]

# Accuracy operation
accuracy = graph_outputs[8]
