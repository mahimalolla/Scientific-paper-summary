...
loss = computation_graph["loss"]
opt = computation_graph["optimisation"]

# ----> Network Outputs <----

raw_predictions = computation_graph["raw_predictions"]
predictions = computation_graph["classification_predictions"]
correct_answers = computation_graph["correct_answers"]
accuracy = computation_graph["accuracy"]
...
print(">>>> FINAL STATS ON ENSEMBLER V1 <<<<")
