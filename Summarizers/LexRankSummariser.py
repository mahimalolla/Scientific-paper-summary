...
SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/LexRank/"
...
class LexRankSummariser(Summariser):
    ...
    def __init__(self):
        ...
        self.summariser = LexRankSummarizer()
    ...
    def summarise(self, filename):
        ...
        summary = [(str(x), 1) for x in summary]
