...
from Dev.Models.SummariserNetClassifier.low_data_summariser_net_v2 import graph, sents2input, SAVE_PATH, NUM_FEATURES,\
    ABSTRACT_DIMENSION, WORD_DIMENSIONS, MAX_SENT_LEN
from operator import itemgetter
from sklearn import linear_model
from Dev.Evaluation.rouge import Rouge

SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/LowDataSummariserNetV2Summariser/"
...
class LowDataSummariserNetSummariser(Summariser):
    """
...
if __name__ == "__main__":
    ...
    summ = LowDataSummariserNetSummariser()
