...
from Dev.Models.LSTMClassifier.lstm_classifier import graph, sents2input, SAVE_PATH, NUM_FEATURES, ABSTRACT_DIMENSION,\
    WORD_DIMENSIONS, MAX_SENT_LEN
from operator import itemgetter
from sklearn import linear_model
from Dev.Evaluation.rouge import Rouge

SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/LSTMSummariser/"
...
class LSTMSummariser(Summariser):
    """
    ...
    def __init__(self):
        ...
        self.inputs = self.computation_graph["inputs"]
    ...
    def summarise(self, filename):
        ...
        with tf.Session() as sess:
            ...
            feed_matrix, sent_lens = sents2input(sentence_list, num_sents)

            # Create the feed_dict
            feed_dict = {
                self.inputs: feed_matrix,
