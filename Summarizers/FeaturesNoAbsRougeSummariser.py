...
from Dev.Models.FeaturesClassifier.features_mlp_no_abs_rouge import graph, SAVE_PATH, NUM_FEATURES
from operator import itemgetter
from sklearn import linear_model
from Dev.Evaluation.rouge import Rouge

SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/FeaturesNoAbsRougeSummariser/"
...
if __name__ == "__main__":
    ...
    summ = FeaturesNoAbsRougeSummariser()
