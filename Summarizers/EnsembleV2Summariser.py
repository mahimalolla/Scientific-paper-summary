...
from Dev.Models.LSTMClassifier.lstm_classifier import graph, sents2input, SAVE_PATH, NUM_FEATURES,\
...
SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/EnsembleV2Summariser/"
