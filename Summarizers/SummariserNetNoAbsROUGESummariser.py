...
from Dev.Models.SummariserNetClassifier.summariser_net_no_absrouge import graph, sents2input, SAVE_PATH, NUM_FEATURES,\
    ABSTRACT_DIMENSION, WORD_DIMENSIONS, MAX_SENT_LEN
from operator import itemgetter
from sklearn import linear_model
from Dev.Evaluation.rouge import Rouge

SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/SummariserNetNoAbsRouge/"
...
class SummariserNetNoAbsROUGESummariser(Summariser):
    """
...
if __name__ == "__main__":
    ...
    summ = SummariserNetNoAbsROUGESummariser()
