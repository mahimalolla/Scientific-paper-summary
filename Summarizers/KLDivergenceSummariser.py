...
SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/KLSummariser/"
...
class KLDivergenceWrapperSummariser(Summariser):
...
if __name__ == "__main__":
    ...
    summ = KLDivergenceWrapperSummariser()
