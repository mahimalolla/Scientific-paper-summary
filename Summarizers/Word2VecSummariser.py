...
from Dev.Models.Word2VecClassifier.word2vec_mlp import graph, SAVE_PATH, WORD_DIMENSIONS
from operator import itemgetter
from sklearn import linear_model
from Dev.Evaluation.rouge import Rouge

SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/Word2VecSummariser/"
...
class Word2VecSummariser(Summariser):
    ...
    def summarise(self, filename):
        ...
        with tf.Session() as sess:
            ...
            probs = sess.run(self.prediction_probs, feed_dict={self.sentences_input: sentence_matrix, self.keep_prob: 1})
