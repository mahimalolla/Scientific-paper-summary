...
from Dev.Models.FeaturesClassifier.low_data_features_mlp import graph, SAVE_PATH, NUM_FEATURES
from operator import itemgetter
from sklearn import linear_model
from Dev.Evaluation.rouge import Rouge

SUMMARY_WRITE_LOC = BASE_DIR + "/Data/Generated_Data/Generated_Summaries/LowDataFeaturesSummariser/"
...
class LowDataFeaturesSummariser(Summariser):
    """
...
if __name__ == "__main__":
    ...
    summ = LowDataFeaturesSummariser()
